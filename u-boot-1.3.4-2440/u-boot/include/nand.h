...
extern int nand_read(nand_info_t *info, off_t ofs, size_t *len, u_char *buf);
extern int nand_write(nand_info_t *info, off_t ofs, size_t *len, u_char *buf);
extern int nand_block_isbad(nand_info_t *info, off_t ofs);
extern int nand_erase(nand_info_t *info, off_t off, size_t size);
#endif
