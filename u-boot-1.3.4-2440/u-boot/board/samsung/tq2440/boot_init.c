...
int NF_ReadID(void)
{
	char pMID __attribute__((unused));
	char pDID __attribute__((unused));
	int  nBuff __attribute__((unused));
	char   n4thcycle __attribute__((unused));
	int i;
	S3C2440_NAND * s3c2440nand = (S3C2440_NAND *)0x4e000000;
	volatile unsigned char *p = (volatile unsigned char *)&s3c2440nand->NFADDR;
...
/* Check Bad Block */
if(1){
		int col __attribute__((unused)), page;
...
static __asm inline void delay(unsigned long loops)
{
1
		subs 	r0, r0, #1
		bne 	%b1
