...
/* led on GPB5~GPB8 */
#define	STATUS_LED_BIT1		(5)
#define	STATUS_LED_BIT2		(6)
#define	STATUS_LED_BIT3		(7)
#define	STATUS_LED_BIT4		(8)
...
void LED_init(void)
{
	...
	gpio->GPBCON &= ~((GPIO_PIN_MASK << STATUS_LED_BIT1*2) | (GPIO_PIN_MASK << STATUS_LED_BIT2*2) \
			| (GPIO_PIN_MASK << STATUS_LED_BIT3*2) | (GPIO_PIN_MASK << STATUS_LED_BIT4*2));
	gpio->GPBCON |= (GPIO_PIN_OUTPUT << STATUS_LED_BIT1*2) | (GPIO_PIN_OUTPUT << STATUS_LED_BIT2*2) \
			| (GPIO_PIN_OUTPUT << STATUS_LED_BIT3*2) | (GPIO_PIN_OUTPUT << STATUS_LED_BIT4*2);
	gpio->GPBUP  &= (GPIO_PULLUP_DIS << STATUS_LED_BIT1) | (GPIO_PULLUP_DIS << STATUS_LED_BIT2) \
			| (GPIO_PULLUP_DIS << STATUS_LED_BIT3) | (GPIO_PULLUP_DIS << STATUS_LED_BIT4);
	if (STATUS_LED_ACTIVE == 0){
		gpio->GPBDAT  |=  ((1 << STATUS_LED_BIT1) | (1 << STATUS_LED_BIT2) | (1 << STATUS_LED_BIT3) | (1 << STATUS_LED_BIT4));
	}else {
		gpio->GPBDAT  &=  ~((1 << STATUS_LED_BIT1) | (1 << STATUS_LED_BIT2) | (1 << STATUS_LED_BIT3) | (1 << STATUS_LED_BIT4));
	}
}
